...
<html>
  ...
  margin: 0 auto;
	   ...
	   <p><a href="index.php"><img src="imagens/home.png" alt="home"></a>
		...
		<p>RELATÓRIO NFE - DESTINATÁRIO</p>
       ...
       if ($a == "buscar") {
	    ...
	    $sql3 = mysql_query("SELECT * FROM nfe INNER JOIN destinatario ON nfe.id_destinatario = destinatario.cnpj_cpf WHERE nome LIKE '%".$palavra."%' ORDER BY emissao");
		...
		// Exibe os produtos e seus respectivos preços
		   while ($produto = mysql_fetch_object($sql3)) {
			echo "Destinatario: ".$produto->nome."<br />";
