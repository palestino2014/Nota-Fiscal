 ...
 <?php
  ...
  $login_cookie = $_COOKIE['login'];
   ...
   $resultado = mysql_query($sql, $conexao) or die ("Não foi possível realizar a consulta 1");			   
		  ...
		  echo "<p>Relatório custo por nota - Cidade e estado (Nfe compra)</p>";		  
               ...
               where emissao >= '$dataInicio' and emissao <='$dataFinal' and UF='$estado' order by municipio";	
		         ...
		         echo "<table border='1px' cellpadding='5px' cellspacing='0' ID='alter'>
                  ...
                  where emissao >= '$dataInicio' and emissao <='$dataFinal' and UF='$estado' order by municipio";   				
					...
					echo "<p>relatorio total</p>";	
					
					 $sql4 = "SELECT * FROM nfe  INNER JOIN emitente ON nfe.id_emitente = emitente.cnpj_cpf 
   where emissao >= '$dataInicio' and emissao <='$dataFinal' order by UF";
   $resultado4 = mysql_query($sql4, $conexao) or die ("Não foi possível realizar a consulta 1");			   
		  ...
		  echo "<table border='1px' cellpadding='5px' cellspacing='0' ID='alter'>
					...
					";
						...
						$sql5 = "SELECT sum(vlr_total),sum(vlr_icms),sum(vlr_ipi),sum(vlr_pis),sum(vlr_cofins)
					   FROM nfe  INNER JOIN emitente ON nfe.id_emitente = emitente.cnpj_cpf 
                  where emissao >= '$dataInicio' and emissao <='$dataFinal' order by UF";   				
 
     					$resultado5 = mysql_query($sql5, $conexao) or die ("Não foi possível realizar a consulta 2");
